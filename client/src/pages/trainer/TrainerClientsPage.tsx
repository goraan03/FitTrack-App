          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-3xl lg:text-4xl font-bold text-white mb-2">
                {t('clients').toUpperCase()} <span className="text-amber-400">{t('all_clients').split(' ')[0].toUpperCase()}</span>
              </h1>
            ...
            <div className="p-6 sm:p-7 space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-[#0a0a0f] border border-[#27273a] p-4 rounded-xl space-y-1">
                  <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest">{t('email')}</p>
              ...
              <div className="bg-[#0a0a0f] border border-[#27273a] rounded-2xl p-4 sm:p-5 space-y-3">
                <div className="flex items-center justify-between">
                  <p className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em]">{t('programs')}</p>
                  {sessionsLoading && <p className="text-[11px] text-slate-500">{t('loading_sessions')}</p>}
                </div>
                {selectedPrograms.length ? (
                        ...
                        <div key={p.id} className="py-3">
                          ...
                          >
                            <div>
                              ...
                              <p className="text-[11px] uppercase text-slate-500 tracking-widest">{t('level')}: {t(p.level)}</p>
                            </div>
                  ...
                  <p className="text-slate-500 text-sm">{t('no_programs_assigned')}</p>
                )}
              </div>
            </div>
          </div>
