          ...
          <div className="mt-8 sm:mt-10 space-y-8">
            ...
            >
              {[
                ...
                {
                  label: t('avg_rating').toUpperCase(),
                ...
                {
                  label: t('total_hours').toUpperCase(),
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-4">
                  {[
                    { label: t('first_name'), value: data.firstName },
                    { label: t('last_name'), value: data.lastName },
                    { label: t('email'), value: data.email, isEmail: true },
                    { label: t('gender'), value: data.gender },
                    { label: t('age'), value: data.age != null ? `${data.age}` : null },
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-lg sm:text-xl font-bold text-white">{t('progress').toUpperCase()}</h2>
                  </div>
