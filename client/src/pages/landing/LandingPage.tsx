...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-emerald-50/60">
      <header className="border-b bg-white/80 backdrop-blur">
        <div className="max-w-7xl mx-auto h-16 px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <Brand />
          <nav className="hidden sm:flex items-center gap-6 text-sm">
            <Link to="/login" className="text-gray-700 hover:text-emerald-700">Sign In</Link>
            <Link to="/register" className="inline-flex items-center rounded-lg bg-emerald-600 text-white px-4 py-2 font-medium hover:bg-emerald-700 transition">
              Get Started
            </Link>
          </nav>
        </div>
      ...
      {/* hero */}
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 sm:pt-20 text-center">
        ...
        <div className="mt-8 flex items-center justify-center gap-3">
          <Link to="/login" className="inline-flex items-center rounded-lg bg-emerald-600 text-white px-5 py-3 font-semibold hover:bg-emerald-700 transition shadow">
            Start Your Journey
          </Link>
          <Link to="/register" className="inline-flex items-center rounded-lg bg-white text-gray-800 px-5 py-3 font-semibold ring-1 ring-gray-200 hover:bg-gray-50 transition">
            Create Account
          </Link>
        </div>
      </section>

      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-14 sm:mt-20">
